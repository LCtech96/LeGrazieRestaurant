...
export default function Footer() {
  ...
  return (
    <footer className="container mx-auto px-4 py-8 border-t border-gray-200 dark:border-gray-800 mt-12">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="text-center md:text-left">
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            Piazza madonna delle grazie, 15
          </p>
          <p className="text-gray-600 dark:text-gray-400 text-sm">
      ...
      {/* Disclaimer Toast */}
      {showDisclaimer && (
        <div className="fixed bottom-24 md:bottom-8 left-1/2 transform -translate-x-1/2 z-50 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 px-6 py-3 rounded-lg shadow-lg animate-fade-in">
